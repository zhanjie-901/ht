    ...
    function getContent() {
        ...
        if (dateStr == "2018-12-30" || dateStr == "2018-12-31" || dateStr == "2019-01-01") {
            ...
            content = "铭记九一八，让历史的风云鞭策我们奋进的脚步，让先烈的忠魂聆听我们自强的怒吼;<br/>" +
                ...
                "勿忘国耻，爱我中华，吾辈当自强！";
        } else if (dateStr == "2020-6-09" || dateStr == "2019-10-02" || dateStr == "2019-10-03" || dateStr == "2019-10-04" || dateStr == "2019-10-05" || dateStr == "2019-10-06" || dateStr == "2019-10-07") {
            ...
            content = "宏图办公系统欢迎你<br/>" +
                "<span style='color:#5cb85c'></span><br/>" +
                "<span id='noticeQQ'></span>";
        }
        return content;
    }
